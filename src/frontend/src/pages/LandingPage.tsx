...
export default function LandingPage({
  ...
  return (
    <div className="overflow-x-hidden">
      {/* Hero */}
      <section className="max-w-[1200px] mx-auto px-4 sm:px-6 pt-12 sm:pt-20 pb-12 sm:pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <h1 className="font-display font-bold text-3xl sm:text-5xl lg:text-6xl leading-tight mb-5">
              Level Up <span className="gradient-text">Every</span>
              <br />
              Aspect of <span className="gradient-text">Your Life</span>
            </h1>

            <p className="text-muted-foreground text-base sm:text-lg leading-relaxed mb-7 max-w-md">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="card-surface rounded-2xl p-4 sm:p-6 glow-cyan">
      ...
      <section className="max-w-[1200px] mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          viewport={{ once: true }}
          className="card-surface rounded-2xl p-6 sm:p-12 text-center glow-cyan"
        >
          ...
          <Button
            ...
            className="gradient-btn text-background font-bold text-base px-8 sm:px-10 py-6 glow-cyan"
          >
            {isLoggingIn ? (
              <>
                <Loader2 className="w-5 h-5 mr-2 animate-spin" />
